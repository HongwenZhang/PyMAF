...
class TrainOptions():
    def __init__(self):
        ...
        io.add_argument('--pretrained_backbone', default=None, help='Load a pretrained backbone at the beginning training')
        
        io.add_argument('--pretrained_body', default=None, help='Load a pretrained checkpoint for body at the beginning training') 
        io.add_argument('--pretrained_hand', default=None, help='Load a pretrained checkpoint for hand at the beginning training') 
        io.add_argument('--pretrained_face', default=None, help='Load a pretrained checkpoint for face at the beginning training') 

        train = self.parser.add_argument_group('Training Options')
        train.add_argument('--num_epochs', type=int, default=201, help='Total number of training epochs')
        ...
        train.add_argument('--train_data', type=str, default='h36m_coco_itw', help='Training datasets selection.')
                                 # choices=['h36m', 'coco', 'agora_val', 'freihand', 'agora_coco', 'h36m_coco', 'h36m_coco_itw', 'expose_coco'], 
        ...
        # train.add_argument('--rescale', type=float, default=1., help='Rescale bounding boxes by a constant factor') 
        train.add_argument('--flip_factor', type=float, default=0.5, help='Flip image probability')
        train.add_argument('--blur_factor', type=float, default=0., help='Blur image probability')
        train.add_argument('--upper_crop_factor', type=float, default=0., help='Crop upper torso probability') 
        ...
        train.add_argument('--eval_every', type=int, default=1, help='Evaluation per epoch')
        train.add_argument('--save_every', type=int, default=5, help='Save per epoch')
